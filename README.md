...
* **🛡️ AI Agent Governance Engine (v1.2.0)**: Built-in automated guardrails, severity-matrix rule verification (`verify.js`), 10 domain skills, execution pipeline, and git pre-commit hooks for AI pair programming.
...
│   ├── manifest.json             # Governance Metadata & Versioning (v1.2.0)
...
├── docs/                         # Core Architecture Specifications
│   ├── architecture.md           # Master Tech Stack & ADRs
│   ├── data_and_api.md           # Serverpod Endpoints & Database Schemas
