...
Mục đích: Đảm bảo mã nguồn Frontend tuân thủ [docs/frontend_and_ui.md](file:///e:/Code/nodetask/docs/frontend_and_ui.md).

## 📋 CHECKLIST KIỂM TRA FRONTEND

- [ ] Sử dụng các CSS variables từ [docs/frontend_and_ui.md](file:///e:/Code/nodetask/docs/frontend_and_ui.md).
