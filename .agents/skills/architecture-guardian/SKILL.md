...
Tất cả các quy tắc bắt buộc tuân thủ được định nghĩa tại [AGENTS.md](file:///e:/Code/nodetask/.agents/AGENTS.md) và tài liệu kiến trúc [docs/architecture.md](file:///e:/Code/nodetask/docs/architecture.md).
