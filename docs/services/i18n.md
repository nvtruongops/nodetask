...
### 9. Cache Policy & Client Caching Strategy
...
- **Purge Rule**: Xóa Redis Key `i18n:dict:{locale}:{namespace}` lập tức khi gọi `updateTranslation`, `bulkUpdateTranslations` hoặc `deleteTranslation`.

#### Browser Client-side Cache Strategy
